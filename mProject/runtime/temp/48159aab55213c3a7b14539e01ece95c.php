...
<html>
	...
	<head>
        ...
        <link rel="icon" type="image/png" href="/static/home/theme/default//static/home/images/favicon.png">
		...
		<header data-am-widget="header" class="am-header am-header-default sq-head1">
			<div class="am-header-left am-header-nav">
		        <a href="city.html" class="" style="color: #fff;">
			        <img src="/static/home/images/city.png" />
...
<div class="am-slider am-slider-default" data-am-flexslider id="demo-slider-0">
  <ul class="am-slides">
    <li><img src="/static/home/images/banner.png" /></li>
    <li><img src="/static/home/images/banner.png" /></li>
  </ul>
</div>
<!--导航-->
 <ul class="sq-nav">
      <li>
        <div class="am-gallery-item">
            <a href="recharge.html" class="">
              <img src="/static/home/images/icon.png" />
              <p>充值</p>
            </a>
        </div>
      </li>
  ...
  <div class="index-product">
  	<div class="index-pro-lf"><a href=""><img src="/static/home/images/s1.png"/></a></div>
  	<div class="index-pro-lr"><a href=""><img src="/static/home/images/s2.png"/></a></div>
  </div>
  <div class="product-bot">
  	<div class="product-bot-lf"><a href=""><img src="/static/home/images/s3.png"/></a></div>
  	<div class="product-bot-lr">
  		<div class="top"><a href=""><img src="/static/home/images/s4.png"/></a></div>
  		<div class="bot">
  			<div class="bot-lf"><a href=""><img src="/static/home/images/s5.png"/></a></div>
  			<div class="bot-lr"><a href=""><img src="/static/home/images/s6.png"/></a></div>
  		</div>
  	</div>
  </div>
  <!--不规则展示-->
  ...
  <!-- 特色专区-->
  <div class="sq-title">
 	<img src="/static/home/images/ts.png" width="26"/>
 	特色专区
  </div>
  <ul data-am-widget="gallery" class="am-gallery pro-list am-avg-sm-2 am-avg-md-2 am-avg-lg-4 am-gallery-default"  >
      <li>
        <div class="am-gallery-item">
            <a href="detail.html" class="">
              <img src=" /static/home/images/test.png" />
      ...
      <li>
        <div class="am-gallery-item">
            <a href="detail.html" class="">
              <img src=" /static/home/images/test1.png" />
        ...
        <div class="am-gallery-item">
            <a href="detail.html" class="">
              <img src=" /static/home/images/test2.png" />
      ...
      <li>
        <div class="am-gallery-item">
            <a href="detail.html" class="">
              <img src=" /static/home/images/test21.png" />
                <h3 class="am-gallery-title">法国加力果12个装 进口新鲜水果 嘎啦苹果 包邮</h3>
                <div class="am-gallery-desc">￥45.8</div>
            </a>
        </div>
...
<div class="qd-box">
	...
	<div class="dq-text">
		<img src="/static/home/images/qiandao.png" width="40" />&nbsp; 您已连续签到3天
	</div>
</div>
<!--签到-->
