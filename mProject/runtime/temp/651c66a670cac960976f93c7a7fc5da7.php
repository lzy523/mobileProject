...
<html>
	...
	<head>
        ...
        <link rel="icon" type="image/png" href="/static/home/theme/default/images/favicon.png">
		...
		<script src="/static/home/js/popup.mini.js"></script>
        <style>
            body{
                background: #f6f6f6;
            }
...
<body>
	    ...
	    <div class="user-list">
		  	<div class="u-list-main">
		  		<img src="/static/home/images/order-pic.png" width="27" />
		  		<span>我的购物订单</span>
		  		<a href="allorder.html">查看全部订单></a>
		  	</div>
		    <ul class="user-nav">
		    	<li><a href="allorder.html"> <img src="/static/home/images/1-icon.png"> <p>待付款</p></a></li>
		    	<li><a href="allorder.html"> <img src="/static/home/images/1-icon1.png"> <p>待收货</p></a></li>
		    	<li><a href="allorder.html"> <img src="/static/home/images/1-icon2.png"> <p>待评价</p></a></li>
		    	<li><a href="allorder.html"> <img src="/static/home/images/1-icon3.png"> <p>退换货</p></a></li>
		    </ul>
		    <div class="u-list-main">
		  		<img src="/static/home/images/order-my.png" width="27" />
		  		<span>帐户与安全</span>
		  	</div>
		    <ul class="user-nav">
		    	<li><a href="infor.html"> <img src="/static/home/images/1-icon4.png"> <p>个人资料</p></a></li>
		    	<li><a href="gladdress.html"> <img src="/static/home/images/1-icon5.png"> <p>收货地址</p></a></li>
		    	<li><a href="saftystep.html"> <img src="/static/home/images/1-icon6.png"> <p>安全设置</p></a></li>
		    	<li><a href="money.html"> <img src="/static/home/images/1-icon7.png"> <p>我的钱包</p></a></li>
		    </ul>
	    </div>
	    <!--导航-->
 <ul class="sq-nav" style=" background: #fff; margin-top: 1rem; border-top: 1px solid #ddd;  border-bottom: 1px solid #ddd;">
      <li>
        <div class="am-gallery-item">
            <a href="job.html" class="">
              <img src="/static/home/images/m_03.png" />
              <p>我要兼职</p>
            </a>
        </div>
      </li>
      <li>
        <div class="am-gallery-item">
            <a href="recommend.html" class="">
              <img src="/static/home/images/m_04.png" />
              <p>推荐有奖</p>
            </a>
        </div>
      </li>
      <li>
        <div class="am-gallery-item">
            <a href="myrecommend.html" class="">
              <img src="/static/home/images/m_05.png" />
              <p>我的推荐</p>
            </a>
        </div>
      </li>
      <li>
        <div class="am-gallery-item">
            <a href="" class="">
              <img src="/static/home/images/m_06.png" />
              <p>我的佣金</p>
            </a>
        </div>
      </li>
      <li>
        <div class="am-gallery-item">
            <a href="yhq.html" class="">
              <img src="/static/home/images/m_02.png" />
              <p>我的红包</p>
            </a>
        </div>
      </li>
      <li>
        <div class="am-gallery-item">
            <a href="message.html" class="">
              <img src="/static/home/images/m_07.png" />
              <p>我的动态</p>
            </a>
        </div>
      </li>
      <li>
        <div class="am-gallery-item">
            <a href="javascript:;" class="index-qd">
              <img src="/static/home/images/m_08.png" />
              <p>客服中心</p>
            </a>
        </div>
      </li>
...
<div class="qd-box">
	...
	<div class="dq-text">
		<a href="http://wpa.qq.com/msgrd?v=3&uin=123456789&site=qq&menu=yes">
			<img src="/static/home/images/contactqq.png" width="50" />
			<p class="contactqq">联系QQ</p>
		</a>
		<a href="tel:0791-12345678">
			<img src="/static/home/images/contacttele.png"  width="50" />
